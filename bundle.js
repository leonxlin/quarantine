(function () {
  ...
  function sayHi() { 
    select('body').html('Hey you guuuys!');
  }
  ...
  window.onload = function() {
      ...
      var nodes = sequence(200).map(function() {
              return {
                  r: Math.random() * 12 + 4
              };
          }),
      ...
      const forceX = x$1(width / 2).strength(0.015);
      const forceY = y$1(height / 2).strength(0.015);
      ...
      var force = simulation()
          ...
          .force("x", forceX)
          .force("y", forceY)
          .force("collide", collide().radius(function(d) {
              if (d === root) {
