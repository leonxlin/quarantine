var quarantine = (function (exports) {
  ...
  function ribbon() {
    ...
    ribbon.radius = function(_) {
      return arguments.length ? (radius = typeof _ === "function" ? _ : constant$4(+_), ribbon) : radius;
    };
  ...
  function dragDisable$1(view) {
    var root = view.document.documentElement,
        selection = select(view).on("dragstart.drag", noevent$3, true);
    if ("onselectstart" in root) {
  ...
  function collideForce (radius) {
      ...
      force.radius = function (_) {
          return arguments.length
              ? ((radius = typeof _ === "function" ? _ : constant$e(+_)),
                  initialize(),
                  force)
              : radius;
      };
  ...
  class Game {
      ...
      fitCanvas() {
          ...
          canvas.width = this.width = Math.min(available_width, available_height * this.CANVAS_ASPECT_RATIO);
          canvas.style.width = left_panel.style.width = this.width + "px";
          canvas.height = this.height = Math.min(available_height, available_width / this.CANVAS_ASPECT_RATIO);
      ...
      shiftAndScaleMouseCoordsToCanvasCoords(p) {
      ...
      scaleMouseCoordsToCanvasCoords(p) {
          return {
